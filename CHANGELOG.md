...
This repository is **Broadsheet**, a fork of [Notifuse](https://github.com/Notifuse/notifuse). The entries below this section describe Notifuse upstream releases; the entries in this section describe changes specific to the fork, on top of whatever upstream version is currently rebased onto `main`.
