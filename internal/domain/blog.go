...
//go:generate mockgen -destination mocks/mock_blog_service.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain BlogService
//go:generate mockgen -destination mocks/mock_blog_category_repository.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain BlogCategoryRepository
//go:generate mockgen -destination mocks/mock_blog_post_repository.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain BlogPostRepository
//go:generate mockgen -destination mocks/mock_blog_theme_repository.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain BlogThemeRepository
