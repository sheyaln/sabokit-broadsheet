...
//go:generate mockgen -destination mocks/mock_contact_segment_queue_repository.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain ContactSegmentQueueRepository
