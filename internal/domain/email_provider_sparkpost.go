...
//go:generate mockgen -destination mocks/mock_sparkpost_service.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain SparkPostServiceInterface
