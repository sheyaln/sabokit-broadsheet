...
// Source: github.com/sheyaln/sabokit-broadsheet/internal/domain (interfaces: TemplateService)
...
import (
	...
	domain "github.com/sheyaln/sabokit-broadsheet/internal/domain"
	broadsheet_mjml "github.com/sheyaln/sabokit-broadsheet/pkg/broadsheet_mjml"
...
func (m *MockTemplateService) CompileTemplate(arg0 context.Context, arg1 broadsheet_mjml.CompileTemplateRequest) (*broadsheet_mjml.CompileTemplateResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CompileTemplate", arg0, arg1)
	ret0, _ := ret[0].(*broadsheet_mjml.CompileTemplateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
