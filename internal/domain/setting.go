...
//go:generate mockgen -destination mocks/mock_setting_repository.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain SettingRepository
