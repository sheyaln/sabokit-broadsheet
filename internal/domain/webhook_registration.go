...
//go:generate mockgen -destination mocks/mock_webhook_registration_service.go -package mocks github.com/sheyaln/sabokit-broadsheet/internal/domain WebhookRegistrationService
