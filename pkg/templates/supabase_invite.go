...
func CreateSupabaseInviteEmailStructure() (broadsheet_mjml.EmailBlock, error) {
	jsonTemplate := `{
  "emailTree": {
    "id": "mjml-1",
    "type": "mjml",
                    ...
                    "children": [
                      {
                        ...
                        "content": "<p>You've been invited!</p>"
                      },
                      {
                        ...
                        "content": "<p>You've been invited to join {{ email_data.site_url }}.<br><br>Click the button below to accept your invitation and create your account:</p>"
                      },
                      {
                      ...
                      },
                      {
                        ...
                        "content": "<p>This link will expire in 7 days.</p><p></p><p>If you weren't expecting this invitation, you can safely ignore this email.</p>"
                      }
                    ]
                  }
                ]
  ...
  "testData": { },
  "exportedAt": "2025-11-03T10:01:31.504Z",
  "version": "1.0"
}`
