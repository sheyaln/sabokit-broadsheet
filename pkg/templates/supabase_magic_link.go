...
func CreateSupabaseMagicLinkEmailStructure() (broadsheet_mjml.EmailBlock, error) {
	jsonTemplate := `{
  "emailTree": {
    "id": "mjml-1",
    "type": "mjml",
                ...
                "children": [
                  {
                    ...
                    "children": [
                      ...
                      },
                      {
                        ...
                        "content": "<p>This link will expire in 1 hour and can only be used once.<br><br>If you didn't request this link, you can safely ignore this email.</p>"
                      }
                    ]
                  }
                ]
  ...
  "testData": {},
  "exportedAt": "2025-11-03T10:02:25.414Z",
  "version": "1.0"
}`
