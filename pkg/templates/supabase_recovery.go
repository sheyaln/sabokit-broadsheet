...
func CreateSupabaseRecoveryEmailStructure() (broadsheet_mjml.EmailBlock, error) {
	jsonTemplate := `{
  "emailTree": {
    "id": "mjml-1",
    "type": "mjml",
                ...
                "children": [
                  {
                    ...
                    "children": [
                      ...
                      },
                      {
                        ...
                        "content": "<p>This link will expire in 1 hour and can only be used once.<br><br>If you didn't request a password reset, you can safely ignore this email. Your password will remain unchanged.</p>"
                      }
                    ]
                  }
                ]
  ...
  "testData": {},
  "exportedAt": "2025-11-03T10:08:45.781Z",
  "version": "1.0"
}`
